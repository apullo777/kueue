...
func TestScheduleForAFS(t *testing.T) {
	...
	cases := map[string]struct {
		...
		// With FairSharingDeepAdmission, both heads are popped before the first
		...
		"deep admission: less active localqueue front-runs by at most the depth before the penalty lands": {
			featureGates: map[featuregate.Feature]bool{
				features.AdmissionFairSharing:     true,
				features.FairSharingDeepAdmission: true,
			},
